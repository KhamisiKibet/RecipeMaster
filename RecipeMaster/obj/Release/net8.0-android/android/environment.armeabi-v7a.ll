...
@dso_cache = dso_local local_unnamed_addr global [586 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 160047853, ; hash 0x98a22ed, from name: aot-RecipeMaster.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 515226974, ; hash 0x1eb5bd5e, from name: aot-RecipeMaster
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecipeMaster.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	...
	%struct.DSOCacheEntry {
		i64 676136783, ; hash 0x284d074f, from name: libaot-RecipeMaster
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecipeMaster.dll.so
		ptr null; void* handle (0x0)
	}, ; 82
	...
	%struct.DSOCacheEntry {
		i64 1008022582, ; hash 0x3c153436, from name: MonkeyCache.FileStore
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1067638824, ; hash 0x3fa2e028, from name: RecipeMaster.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecipeMaster.dll.so
		ptr null; void* handle (0x0)
	}, ; 132
	...
	%struct.DSOCacheEntry {
		i64 1314471538, ; hash 0x4e593e72, from name: MonkeyCache.FileStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-MonkeyCache.FileStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 159
	...
	%struct.DSOCacheEntry {
		i64 1868337283, ; hash 0x6f5c9083, from name: libaot-MonkeyCache.FileStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-MonkeyCache.FileStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 233
	...
	%struct.DSOCacheEntry {
		i64 2784965738, ; hash 0xa5ff346a, from name: aot-MonkeyCache.FileStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-MonkeyCache.FileStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 374
	...
	%struct.DSOCacheEntry {
		i64 3333760503, ; hash 0xc6b525f7, from name: libaot-RecipeMaster.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecipeMaster.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
	...
	%struct.DSOCacheEntry {
		i64 3691342887, ; hash 0xdc056c27, from name: RecipeMaster
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecipeMaster.dll.so
		ptr null; void* handle (0x0)
	}, ; 504
	...
	%struct.DSOCacheEntry {
		i64 3819177890, ; hash 0xe3a407a2, from name: aot-MonkeyCache.FileStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-MonkeyCache.FileStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 522
	...
	%struct.DSOCacheEntry {
		i64 4229863665, ; hash 0xfc1e98f1, from name: libaot-MonkeyCache.FileStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-MonkeyCache.FileStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 577
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [127 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
